$(function () {
   ...
   $(".dropdown").on('hover', function () {
    ...
    //     var myLatlng = new google.maps.LatLng(40.173237, 44.4581685);
...
//  BOOKMART  saved page
$('.toggle-icon.remove').click(function(){
  $(this).parents(".remove-box").fadeOut(500,function(){
    $(this).remove();
  });
});
